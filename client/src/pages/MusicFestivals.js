...
import '../styles/MusicFestivals.css';
...
const MusicFestivals = () => {
  return (
    <div className='musicfestivalsday-container'>
        <h1>Music Festivals</h1>
        <hr className='horizontal'/>
        <div className='musicfestivalsday-content'>
          <div className='mfday-leftside'>
            <div className='mfday-menu'>
              <Accordion>

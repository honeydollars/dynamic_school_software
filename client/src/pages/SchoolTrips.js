...
const SchoolTrips = () => {
  return (
    <div className='tripday-container'>
        <h1>School Trips</h1>
        <hr className='horizontal'/>
        <div className='tripday-content'>
          <div className='tday-leftside'>
            <div className='tday-menu'>
              <Accordion>

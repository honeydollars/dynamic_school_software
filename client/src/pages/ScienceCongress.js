...
import '../styles/ScienceCongress.css';
...
const ScienceCongress = () => {
  return (
    <div className='sciencefairday-container'>
        <h1>Science Congress</h1>
        <hr className='horizontal'/>
        <div className='sciencefairday-content'>
          <div className='sfday-leftside'>
            <div className='sfday-menu'>
              <Accordion>
...
export default ScienceCongress;